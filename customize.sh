...
ui_print "--------------------------------------------"
ui_print "   AOSP Low-Latency VoIP Fix v2.6-Pro"
...
ui_print "  [2/4] system.prop                      (Latency tuning + Fluence)"
ui_print "  [3/4] service.sh                       (Optimization & Debug Logs)"
ui_print "  [4/4] post-fs-data.sh                  (Early Boot Logging)"
ui_print ""
ui_print "- v2.6 Pro Latency & Ducking Fixed:"
ui_print "    * Relaxed AAudio MMAP (policy=1) to prevent OpenSL ES fallback"
ui_print "    * Disabled Fluence VoiceComm to fix volume ducking in VoIP"
ui_print "    * Aligned with hardware buffers: 192 (Out) / 144 (In)"
ui_print ""
