...
ui_print "--------------------------------------------"
ui_print "   AOSP Low-Latency VoIP Fix v2.5-Pro"
...
ui_print ""
ui_print "- v2.5 Pro Verified Stability Applied:"
ui_print "    * Aligned with hardware buffers: 192 (Out) / 144 (In)"
ui_print "    * Forced AAudio MMAP (policy=2)"
ui_print "    * Fixed audioserver crashes (Removed high-precision resampler)"
ui_print "    * Maximum compatibility (Removed voip_rx RAW flag)"
